...
| 2 | Als Technical Architect will ich die Systemarchitektur (Sync & Datenmodell) in der TechDoc definieren, um Planungsfehler zu vermeiden. | 5 | LS | MH | [Status](#issue-2) |
...
| 4 | Als Benutzer will ich mich registrieren und anmelden (Auth), um meine Listen geschützt zu verwalten. | 5 | DEV2 | MH | [Status](#issue-4) |
...
| 10 | Als Product Owner will ich Listen per Link teilen ("Sharing"), um kollaborativ einzukaufen. | 5 | VW | MH | [Status](#issue-10) |
...
| 17 | Als Entwickler will ich ein Einstellungs-Menü (User Profile, Logout) implementieren, um Account-Daten zu verwalten. | 5 | DEV1 | SH | [Status](#issue-17) |
...
| 20 | Als Entwickler will ich eine Backup/Export-Funktion für Listen implementieren (JSON Download), um Datenverlust vorzubeugen. | 5 | DEV3 | N2H | [Status](#issue-20) |
...
*Arbeitsverteilung (Total: 120 SP):*

* **VW (Product Owner):** 24 SP
  * *Tasks:* Listenverwaltung, Items, Sharing, Labels, Notizen, Filter, Suche.
* **LS (Technical Architect):** 24 SP
  * *Tasks:* Architektur/TechDoc, DB Setup, Offline-Logik, CI/CD, Dokumentation.
* **DEV1:** 24 SP
  * *Tasks:* Upstream Sync, Unit Tests, User Settings, Dark Mode, Animationen.
* **DEV2:** 24 SP
  * *Tasks:* Auth, Downstream Sync, Konfliktlösung, Error Handling/Validierung.
* **DEV3:** 24 SP
  * *Tasks:* Setup, E2E Tests, Global Deployment, Backup-Feature, Accessibility.
